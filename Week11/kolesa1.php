<html>
   ...
   <body>
      <a href="kolesa1.php">All</a>|<a href="kolesa1.php?category=Toyota">Toyota</a>|<a href="kolesa1.php?category=BMW">BMW</a>
      <?php
         ...
         $sql = "SELECT * FROM kolesa WHERE maker='".$_REQUEST["category"]."'";
      }
      else{
